...
# $Id: kl.py xxxx 2015-01-06 12:30:00 lheijst $
#
...
[KlimaLogg]
    ...
    #
    # WARNING: After a change of the sensor_map you have to clear the weewx database
    # first to avoid 'apples and pears' data mixed.
    #
    [[sensor_map]]
        TempIn     = inTemp       # save Klimalogg Pro base station temperature as inTemp
        HumidityIn = inHumidity   # save KlimaLogg Pro base station humidity as inHumidity
...
class USBHardware(object):
    ...
    @staticmethod
    def moveBuf(bufin, startin, len, bufout, startout):
        """move len bytes from bufin to bufout"""
        for i in xrange(0,len):
            bufout[0][i+startout] = bufin[0][i+startin]
        return
...
class CCurrentWeatherData(object):
    ...
    def read(self, buf):
        ...
        self.SignalQuality = (nbuf[0][4] & 0x7F)
        ...
        self.TempInMinMax._Max._Time = None if self.TempInMinMax._Max._IsError or self.TempInMinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 18, 0, 'TempInMax')
        self.TempInMinMax._Min._Time = None if self.TempInMinMax._Min._IsError or self.TempInMinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 22, 0, 'TempInMin')
        ...
        self.HumidityInMinMax._Max._Time = None if self.HumidityInMinMax._Max._IsError or self.HumidityInMinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 7, 1, 'HumidityInMax')
        self.HumidityInMinMax._Min._Time = None if self.HumidityInMinMax._Min._IsError or self.HumidityInMinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 11, 1, 'HumidityInMin')
        ...
        self.Temp1MinMax._Max._Time = None if self.Temp1MinMax._Max._IsError or self.Temp1MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 42, 0, 'Temp1Max')
        self.Temp1MinMax._Min._Time = None if self.Temp1MinMax._Min._IsError or self.Temp1MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 46, 0, 'Temp1Min')
        ...
        self.Humidity1MinMax._Max._Time = None if self.Humidity1MinMax._Max._IsError or self.Humidity1MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 31, 1, 'Humidity1Max')
        self.Humidity1MinMax._Min._Time = None if self.Humidity1MinMax._Min._IsError or self.Humidity1MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 35, 1, 'Humidity1Min')
        ...
        self.Temp2MinMax._Max._Time = None if self.Temp2MinMax._Max._IsError or self.Temp2MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 66, 0, 'Temp2Max')
        self.Temp2MinMax._Min._Time = None if self.Temp2MinMax._Min._IsError or self.Temp2MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 70, 0, 'Temp2Min')
        ...
        self.Humidity2MinMax._Max._Time = None if self.Humidity2MinMax._Max._IsError or self.Humidity2MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 55, 1, 'Humidity2Max')
        self.Humidity2MinMax._Min._Time = None if self.Humidity2MinMax._Min._IsError or self.Humidity2MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 59, 1, 'Humidity2Min')
        ...
        self.Temp3MinMax._Max._Time = None if self.Temp3MinMax._Max._IsError or self.Temp3MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 90, 0, 'Temp3Max')
        self.Temp3MinMax._Min._Time = None if self.Temp3MinMax._Min._IsError or self.Temp3MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 94, 0, 'Temp3Min')
        ...
        self.Humidity3MinMax._Max._Time = None if self.Humidity3MinMax._Max._IsError or self.Humidity3MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 79, 1, 'Humidity3Max')
        self.Humidity3MinMax._Min._Time = None if self.Humidity3MinMax._Min._IsError or self.Humidity3MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 83, 1, 'Humidity3Min')
        ...
        self.Temp4MinMax._Max._Time = None if self.Temp4MinMax._Max._IsError or self.Temp4MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 114, 0, 'Temp4Max')
        self.Temp4MinMax._Min._Time = None if self.Temp4MinMax._Min._IsError or self.Temp4MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 118, 0, 'Temp4Min')
        ...
        self.Humidity4MinMax._Max._Time = None if self.Humidity4MinMax._Max._IsError or self.Humidity4MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 103, 1, 'Humidity4Max')
        self.Humidity4MinMax._Min._Time = None if self.Humidity4MinMax._Min._IsError or self.Humidity4MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 107, 1, 'Humidity4Min')
        ...
        self.Temp5MinMax._Max._Time = None if self.Temp5MinMax._Max._IsError or self.Temp5MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 138, 0, 'Temp5Max')
        self.Temp5MinMax._Min._Time = None if self.Temp5MinMax._Min._IsError or self.Temp5MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 142, 0, 'Temp5Min')
        ...
        self.Humidity5MinMax._Max._Time = None if self.Humidity5MinMax._Max._IsError or self.Humidity5MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 127, 1, 'Humidity5Max')
        self.Humidity5MinMax._Min._Time = None if self.Humidity5MinMax._Min._IsError or self.Humidity5MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 131, 1, 'Humidity5Min')
        ...
        self.Temp6MinMax._Max._Time = None if self.Temp6MinMax._Max._IsError or self.Temp6MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 162, 0, 'Temp6Max')
        self.Temp6MinMax._Min._Time = None if self.Temp6MinMax._Min._IsError or self.Temp6MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 166, 0, 'Temp6Min')
        ...
        self.Humidity6MinMax._Max._Time = None if self.Humidity6MinMax._Max._IsError or self.Humidity6MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 151, 1, 'Humidity6Max')
        self.Humidity6MinMax._Min._Time = None if self.Humidity6MinMax._Min._IsError or self.Humidity6MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 155, 1, 'Humidity6Min')
        ...
        self.Temp7MinMax._Max._Time = None if self.Temp7MinMax._Max._IsError or self.Temp7MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 186, 0, 'Temp7Max')
        self.Temp7MinMax._Min._Time = None if self.Temp7MinMax._Min._IsError or self.Temp7MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 190, 0, 'Temp7Min')
        ...
        self.Humidity7MinMax._Max._Time = None if self.Humidity7MinMax._Max._IsError or self.Humidity7MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 175, 1, 'Humidity7Max')
        self.Humidity7MinMax._Min._Time = None if self.Humidity7MinMax._Min._IsError or self.Humidity7MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 179, 1, 'Humidity7Min')
        ...
        self.Temp8MinMax._Max._Time = None if self.Temp8MinMax._Max._IsError or self.Temp8MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 210, 0, 'Temp8Max')
        self.Temp8MinMax._Min._Time = None if self.Temp8MinMax._Min._IsError or self.Temp8MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 214, 0, 'Temp8Min')
        ...
        self.Humidity8MinMax._Max._Time = None if self.Humidity8MinMax._Max._IsError or self.Humidity8MinMax._Max._IsOverflow else USBHardware.toDateTime8(nbuf, 199, 1, 'Humidity8Max')
        self.Humidity8MinMax._Min._Time = None if self.Humidity8MinMax._Min._IsError or self.Humidity8MinMax._Min._IsOverflow else USBHardware.toDateTime8(nbuf, 203, 1, 'Humidity8Min')

    def toLog(self):
        logdbg("SignalQuality %3.0f " % self.SignalQuality)
        logdbg("TempIn=    %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.TempIn, self.TempInMinMax._Min._Value, self.TempInMinMax._Min._Time, self.TempInMinMax._Max._Value, self.TempInMinMax._Max._Time))
        logdbg("HumidityIn=%6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.HumidityIn, self.HumidityInMinMax._Min._Value, self.HumidityInMinMax._Min._Time, self.HumidityInMinMax._Max._Value, self.HumidityInMinMax._Max._Time))
        if get_datum_diff(self.Temp1, CWeatherTraits.TemperatureNP(), CWeatherTraits.TemperatureOFL()) is not None:       
            logdbg("Temp1=     %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Temp1, self.Temp1MinMax._Min._Value, self.Temp1MinMax._Min._Time, self.Temp1MinMax._Max._Value, self.Temp1MinMax._Max._Time))
        if get_datum_diff(self.Humidity1, CWeatherTraits.HumidityNP(), CWeatherTraits.HumidityOFL()) is not None:
            logdbg("Humidity1= %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Humidity1, self.Humidity1MinMax._Min._Value, self.Humidity1MinMax._Min._Time, self.Humidity1MinMax._Max._Value, self.Humidity1MinMax._Max._Time))
        if get_datum_diff(self.Temp2, CWeatherTraits.TemperatureNP(), CWeatherTraits.TemperatureOFL()) is not None:  
            logdbg("Temp2=     %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Temp2, self.Temp2MinMax._Min._Value, self.Temp2MinMax._Min._Time, self.Temp2MinMax._Max._Value, self.Temp2MinMax._Max._Time))
        if get_datum_diff(self.Humidity2, CWeatherTraits.HumidityNP(), CWeatherTraits.HumidityOFL()) is not None:
            logdbg("Humidity2= %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Humidity2, self.Humidity2MinMax._Min._Value, self.Humidity2MinMax._Min._Time, self.Humidity2MinMax._Max._Value, self.Humidity2MinMax._Max._Time))
        if get_datum_diff(self.Temp3, CWeatherTraits.TemperatureNP(), CWeatherTraits.TemperatureOFL()) is not None:  
            logdbg("Temp3=     %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Temp3, self.Temp3MinMax._Min._Value, self.Temp3MinMax._Min._Time, self.Temp3MinMax._Max._Value, self.Temp3MinMax._Max._Time))
        if get_datum_diff(self.Humidity3, CWeatherTraits.HumidityNP(), CWeatherTraits.HumidityOFL()) is not None:
            logdbg("Humidity3= %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Humidity3, self.Humidity3MinMax._Min._Value, self.Humidity3MinMax._Min._Time, self.Humidity3MinMax._Max._Value, self.Humidity3MinMax._Max._Time))
        if get_datum_diff(self.Temp4, CWeatherTraits.TemperatureNP(), CWeatherTraits.TemperatureOFL()) is not None:  
            logdbg("Temp4=     %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Temp4, self.Temp4MinMax._Min._Value, self.Temp4MinMax._Min._Time, self.Temp4MinMax._Max._Value, self.Temp4MinMax._Max._Time))
        if get_datum_diff(self.Humidity4, CWeatherTraits.HumidityNP(), CWeatherTraits.HumidityOFL()) is not None:
            logdbg("Humidity4= %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Humidity4, self.Humidity4MinMax._Min._Value, self.Humidity4MinMax._Min._Time, self.Humidity4MinMax._Max._Value, self.Humidity4MinMax._Max._Time))
        if get_datum_diff(self.Temp5, CWeatherTraits.TemperatureNP(), CWeatherTraits.TemperatureOFL()) is not None:  
            logdbg("Temp5=     %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Temp5, self.Temp5MinMax._Min._Value, self.Temp5MinMax._Min._Time, self.Temp5MinMax._Max._Value, self.Temp5MinMax._Max._Time))
        if get_datum_diff(self.Humidity5, CWeatherTraits.HumidityNP(), CWeatherTraits.HumidityOFL()) is not None:
            logdbg("Humidity5= %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Humidity5, self.Humidity5MinMax._Min._Value, self.Humidity5MinMax._Min._Time, self.Humidity5MinMax._Max._Value, self.Humidity5MinMax._Max._Time))
        if get_datum_diff(self.Temp6, CWeatherTraits.TemperatureNP(), CWeatherTraits.TemperatureOFL()) is not None:   
            logdbg("Temp6=     %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Temp6, self.Temp6MinMax._Min._Value, self.Temp6MinMax._Min._Time, self.Temp6MinMax._Max._Value, self.Temp6MinMax._Max._Time))
        if get_datum_diff(self.Humidity6, CWeatherTraits.HumidityNP(), CWeatherTraits.HumidityOFL()) is not None: 
            logdbg("Humidity6= %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Humidity6, self.Humidity6MinMax._Min._Value, self.Humidity6MinMax._Min._Time, self.Humidity6MinMax._Max._Value, self.Humidity6MinMax._Max._Time))
        if get_datum_diff(self.Temp7, CWeatherTraits.TemperatureNP(), CWeatherTraits.TemperatureOFL()) is not None:   
            logdbg("Temp7=     %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Temp7, self.Temp7MinMax._Min._Value, self.Temp7MinMax._Min._Time, self.Temp7MinMax._Max._Value, self.Temp7MinMax._Max._Time))
        if get_datum_diff(self.Humidity7, CWeatherTraits.HumidityNP(), CWeatherTraits.HumidityOFL()) is not None: 
            logdbg("Humidity7= %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Humidity7, self.Humidity7MinMax._Min._Value, self.Humidity7MinMax._Min._Time, self.Humidity7MinMax._Max._Value, self.Humidity7MinMax._Max._Time))
        if get_datum_diff(self.Temp8, CWeatherTraits.TemperatureNP(), CWeatherTraits.TemperatureOFL()) is not None:  
            logdbg("Temp8=     %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Temp8, self.Temp8MinMax._Min._Value, self.Temp8MinMax._Min._Time, self.Temp8MinMax._Max._Value, self.Temp8MinMax._Max._Time))
        if get_datum_diff(self.Humidity8, CWeatherTraits.HumidityNP(), CWeatherTraits.HumidityOFL()) is not None:
            logdbg("Humidity8= %6.1f  _Min=%6.1f (%s)  _Max=%6.1f (%s)" % (self.Humidity8, self.Humidity8MinMax._Min._Value, self.Humidity8MinMax._Min._Time, self.Humidity8MinMax._Max._Value, self.Humidity8MinMax._Max._Time))
...
class CWeatherStationConfig(object):
    def __init__(self):
        ...
        self._Data = [0]*5
        self._Description1 = [0]*8
        self._Description2 = [0]*8
        self._Description3 = [0]*8
        self._Description4 = [0]*8
        self._Description5 = [0]*8
        self._Description6 = [0]*8
        self._Description7 = [0]*8
        self._Description8 = [0]*8
        self._Lastbyte = 0
    ...
    def read(self, buf):
        nbuf=[0]
        nbuf[0]=buf[0]
        self._Parameter1 = nbuf[0][5]
        self._Parameter2 = nbuf[0][6]
        self._HistoryInterval = nbuf[0][7] & 0xF
        self._TempInMinMax._Max._Value = USBHardware.toTemperature_3_1(nbuf, 8, 1)
        self._TempInMinMax._Min._Value = USBHardware.toTemperature_3_1(nbuf, 9, 0)
        self._Temp1MinMax._Max._Value = USBHardware.toTemperature_3_1(nbuf, 11, 1)
        self._Temp1MinMax._Min._Value = USBHardware.toTemperature_3_1(nbuf, 12, 0)
        self._Temp2MinMax._Max._Value = USBHardware.toTemperature_3_1(nbuf, 14, 1)
        self._Temp2MinMax._Min._Value = USBHardware.toTemperature_3_1(nbuf, 15, 0)
        self._Temp3MinMax._Max._Value = USBHardware.toTemperature_3_1(nbuf, 17, 1)
        self._Temp3MinMax._Min._Value = USBHardware.toTemperature_3_1(nbuf, 18, 0)
        self._Temp4MinMax._Max._Value = USBHardware.toTemperature_3_1(nbuf, 20, 1)
        self._Temp4MinMax._Min._Value = USBHardware.toTemperature_3_1(nbuf, 21, 0)
        self._Temp5MinMax._Max._Value = USBHardware.toTemperature_3_1(nbuf, 23, 1)
        self._Temp5MinMax._Min._Value = USBHardware.toTemperature_3_1(nbuf, 24, 0)
        self._Temp6MinMax._Max._Value = USBHardware.toTemperature_3_1(nbuf, 26, 1)
        self._Temp6MinMax._Min._Value = USBHardware.toTemperature_3_1(nbuf, 27, 0)
        self._Temp7MinMax._Max._Value = USBHardware.toTemperature_3_1(nbuf, 29, 1)
        self._Temp7MinMax._Min._Value = USBHardware.toTemperature_3_1(nbuf, 30, 0)
        self._Temp8MinMax._Max._Value = USBHardware.toTemperature_3_1(nbuf, 32, 1)
        self._Temp8MinMax._Min._Value = USBHardware.toTemperature_3_1(nbuf, 33, 0)
        self._HumidityInMinMax._Max._Value = USBHardware.toHumidity_2_0(nbuf, 35, 1)
        self._HumidityInMinMax._Min._Value = USBHardware.toHumidity_2_0(nbuf, 36, 1)
        self._Humidity1MinMax._Max._Value = USBHardware.toHumidity_2_0(nbuf, 37, 1)
        self._Humidity1MinMax._Min._Value = USBHardware.toHumidity_2_0(nbuf, 38, 1)
        self._Humidity2MinMax._Max._Value = USBHardware.toHumidity_2_0(nbuf, 39, 1)
        self._Humidity2MinMax._Min._Value = USBHardware.toHumidity_2_0(nbuf, 40, 1)
        self._Humidity3MinMax._Max._Value = USBHardware.toHumidity_2_0(nbuf, 41, 1)
        self._Humidity3MinMax._Min._Value = USBHardware.toHumidity_2_0(nbuf, 42, 1)
        self._Humidity4MinMax._Max._Value = USBHardware.toHumidity_2_0(nbuf, 43, 1)
        self._Humidity4MinMax._Min._Value = USBHardware.toHumidity_2_0(nbuf, 44, 1)
        self._Humidity5MinMax._Max._Value = USBHardware.toHumidity_2_0(nbuf, 45, 1)
        self._Humidity5MinMax._Min._Value = USBHardware.toHumidity_2_0(nbuf, 46, 1)
        self._Humidity6MinMax._Max._Value = USBHardware.toHumidity_2_0(nbuf, 47, 1)
        self._Humidity6MinMax._Min._Value = USBHardware.toHumidity_2_0(nbuf, 48, 1)
        self._Humidity7MinMax._Max._Value = USBHardware.toHumidity_2_0(nbuf, 49, 1)
        self._Humidity7MinMax._Min._Value = USBHardware.toHumidity_2_0(nbuf, 50, 1)
        self._Humidity8MinMax._Max._Value = USBHardware.toHumidity_2_0(nbuf, 51, 1)
        self._Humidity8MinMax._Min._Value = USBHardware.toHumidity_2_0(nbuf, 52, 1)
        USBHardware.moveBuf(nbuf, 53, 5, self._Data, 0)
        USBHardware.moveBuf(nbuf, 58, 8, self._Description1, 0)
        USBHardware.moveBuf(nbuf, 66, 8, self._Description2, 0)
        USBHardware.moveBuf(nbuf, 74, 8, self._Description3, 0)
        USBHardware.moveBuf(nbuf, 82, 8, self._Description4, 0)
        USBHardware.moveBuf(nbuf, 90, 8, self._Description5, 0)
        USBHardware.moveBuf(nbuf, 98, 8, self._Description6, 0)
        USBHardware.moveBuf(nbuf, 106, 8, self._Description7, 0)
        USBHardware.moveBuf(nbuf, 114, 8, self._Description8, 0)
        self._Lastbyte = nbuf[0][122]
        self._InBufCS = (nbuf[0][123] << 8) | nbuf[0][124]
        self._OutBufCS = calc_checksum(buf, 5, end=122) + 7
        # Set historyInterval to 5 minutes if is is > 5 minutes (default: 15 minutes)
        ###lh if self._HistoryInterval > EHistoryInterval.hi05Min:
    ...
    def testConfigChanged(self, buf):
        ...
        nbuf[0] = [0]*125
        nbuf[0] = buf[0]
        nbuf[0][5] = self._Parameter1
        nbuf[0][6] = self._Parameter2
        nbuf[0][7] = self._HistoryInterval
        self.parse_1(self._TempInMinMax._Max._Value + CWeatherTraits.TemperatureOffset(), nbuf, 8, 1, 3)
        self.parse_1(self._TempInMinMax._Min._Value + CWeatherTraits.TemperatureOffset(), nbuf, 9, 0, 3)
        USBHardware.reverseByteOrder(nbuf, 8, 3)  #TempIn
        self.parse_1(self._Temp1MinMax._Max._Value + CWeatherTraits.TemperatureOffset(), nbuf, 11, 1, 3)
        self.parse_1(self._Temp1MinMax._Min._Value + CWeatherTraits.TemperatureOffset(), nbuf, 12, 0, 3)
        USBHardware.reverseByteOrder(nbuf, 11, 3) #Temp1
        self.parse_1(self._Temp2MinMax._Max._Value + CWeatherTraits.TemperatureOffset(), nbuf, 14, 1, 3)
        self.parse_1(self._Temp2MinMax._Min._Value + CWeatherTraits.TemperatureOffset(), nbuf, 15, 0, 3)
        USBHardware.reverseByteOrder(nbuf, 14, 3) #Temp2
        self.parse_1(self._Temp3MinMax._Max._Value + CWeatherTraits.TemperatureOffset(), nbuf, 17, 1, 3)
        self.parse_1(self._Temp3MinMax._Min._Value + CWeatherTraits.TemperatureOffset(), nbuf, 18, 0, 3)
        USBHardware.reverseByteOrder(nbuf, 17, 3) #Temp3
        self.parse_1(self._Temp4MinMax._Max._Value + CWeatherTraits.TemperatureOffset(), nbuf, 20, 1, 3)
        self.parse_1(self._Temp4MinMax._Min._Value + CWeatherTraits.TemperatureOffset(), nbuf, 21, 0, 3)
        USBHardware.reverseByteOrder(nbuf, 20, 3) #Temp4
        self.parse_1(self._Temp5MinMax._Max._Value + CWeatherTraits.TemperatureOffset(), nbuf, 23, 1, 3)
        self.parse_1(self._Temp5MinMax._Min._Value + CWeatherTraits.TemperatureOffset(), nbuf, 24, 0, 3)
        USBHardware.reverseByteOrder(nbuf, 23, 3) #Temp5
        self.parse_1(self._Temp6MinMax._Max._Value + CWeatherTraits.TemperatureOffset(), nbuf, 26, 1, 3)
        self.parse_1(self._Temp6MinMax._Min._Value + CWeatherTraits.TemperatureOffset(), nbuf, 27, 0, 3)
        USBHardware.reverseByteOrder(nbuf, 26, 3) #Temp6
        self.parse_1(self._Temp7MinMax._Max._Value + CWeatherTraits.TemperatureOffset(), nbuf, 29, 1, 3)
        self.parse_1(self._Temp7MinMax._Min._Value + CWeatherTraits.TemperatureOffset(), nbuf, 30, 0, 3)
        USBHardware.reverseByteOrder(nbuf, 29, 3) #Temp7
        self.parse_1(self._Temp8MinMax._Max._Value + CWeatherTraits.TemperatureOffset(), nbuf, 32, 1, 3)
        self.parse_1(self._Temp8MinMax._Min._Value + CWeatherTraits.TemperatureOffset(), nbuf, 33, 0, 3)
        USBHardware.reverseByteOrder(nbuf, 32, 3) #Temp8
        self.parse_0(self._HumidityInMinMax._Max._Value, nbuf, 35, 1, 2)
        self.parse_0(self._HumidityInMinMax._Min._Value, nbuf, 36, 1, 2)
        USBHardware.reverseByteOrder(nbuf, 35, 2) #HumidityIn
        self.parse_0(self._Humidity1MinMax._Max._Value, nbuf, 37, 1, 2)
        self.parse_0(self._Humidity1MinMax._Min._Value, nbuf, 38, 1, 2)
        USBHardware.reverseByteOrder(nbuf, 37, 2) #Humidity1
        self.parse_0(self._Humidity2MinMax._Max._Value, nbuf, 39, 1, 2)
        self.parse_0(self._Humidity2MinMax._Min._Value, nbuf, 40, 1, 2)
        USBHardware.reverseByteOrder(nbuf, 39, 2) #Humidity2
        self.parse_0(self._Humidity3MinMax._Max._Value, nbuf, 41, 1, 2)
        self.parse_0(self._Humidity3MinMax._Min._Value, nbuf, 42, 1, 2)
        USBHardware.reverseByteOrder(nbuf, 41, 2) #Humidity3
        self.parse_0(self._Humidity4MinMax._Max._Value, nbuf, 43, 1, 2)
        self.parse_0(self._Humidity4MinMax._Min._Value, nbuf, 44, 1, 2)
        USBHardware.reverseByteOrder(nbuf, 43, 2) #Humidity4
        self.parse_0(self._Humidity5MinMax._Max._Value, nbuf, 45, 1, 2)
        self.parse_0(self._Humidity5MinMax._Min._Value, nbuf, 46, 1, 2)
        USBHardware.reverseByteOrder(nbuf, 45, 2) #Humidity5
        self.parse_0(self._Humidity6MinMax._Max._Value, nbuf, 47, 1, 2)
        self.parse_0(self._Humidity6MinMax._Min._Value, nbuf, 48, 1, 2)
        USBHardware.reverseByteOrder(nbuf, 47, 2) #Humidity6
        self.parse_0(self._Humidity7MinMax._Max._Value, nbuf, 49, 1, 2)
        self.parse_0(self._Humidity7MinMax._Min._Value, nbuf, 50, 1, 2)
        USBHardware.reverseByteOrder(nbuf, 49, 2) #Humidity7
        self.parse_0(self._Humidity8MinMax._Max._Value, nbuf, 51, 1, 2)
        self.parse_0(self._Humidity8MinMax._Min._Value, nbuf, 52, 1, 2)
        USBHardware.reverseByteOrder(nbuf, 51, 2) #Humidity8
        USBHardware.moveBuf(self._Data, 0, 5, nbuf, 53)
        USBHardware.reverseByteOrder(self._Data, 53, 5) #Data
        USBHardware.moveBuf(self._Description1, 0, 8, nbuf, 58)
        USBHardware.reverseByteOrder(self._Description1, 58, 8) #Description1
        USBHardware.moveBuf(self._Description2, 0, 8, nbuf, 66)
        USBHardware.reverseByteOrder(self._Description2, 66, 8) #Description2
        USBHardware.moveBuf(self._Description3, 0, 8, nbuf, 74)
        USBHardware.reverseByteOrder(self._Description3, 74, 8) #Description3
        USBHardware.moveBuf(self._Description4, 0, 8, nbuf, 82)
        USBHardware.reverseByteOrder(self._Description4, 82, 8) #Description4
        USBHardware.moveBuf(self._Description5, 0, 8, nbuf, 90)
        USBHardware.reverseByteOrder(self._Description5, 90, 8) #Description5
        USBHardware.moveBuf(self._Description6, 0, 8, nbuf, 98)
        USBHardware.reverseByteOrder(self._Description6, 98, 8) #Description6
        USBHardware.moveBuf(self._Description7, 0, 8, nbuf, 106)
        USBHardware.reverseByteOrder(self._Description7, 106, 8)#Description7
        USBHardware.moveBuf(self._Description8, 0, 8, nbuf, 114)
        USBHardware.reverseByteOrder(self._Description8, 114, 8)#Description8
        nbuf[0][122] = self._Lastbyte
        self._OutBufCS = calc_checksum(nbuf, 5, end=122) + 7
        nbuf[0][123] = (self._OutBufCS >> 8) & 0xFF
        nbuf[0][124] = (self._OutBufCS >> 0) & 0xFF
        buf[0] = nbuf[0]   
        if self._OutBufCS == self._InBufCS:
            if DEBUG_CONFIG_DATA > 2:
                logdbg('testConfigChanged: checksum not changed: OutBufCS=%04x' % self._OutBufCS)
            changed = 0
        else:
            if DEBUG_CONFIG_DATA > 0:
                logdbg('testConfigChanged: checksum changed: OutBufCS=%04x InBufCS=%04x ' % (self._OutBufCS, self._InBufCS))
            if DEBUG_CONFIG_DATA > 1:
                self.toLog()
            changed = 1
            ###lh temporary set change to 0 until we checked the checksum calculation
            changed = 0
        return changed

    def toLog(self):
        logdbg('OutBufCS=       %02x' % self._OutBufCS)
        logdbg('InBufCS=        %02x' % self._InBufCS)
        logdbg('Parameter1=     %02x' % self._Parameter1)
        logdbg('Parameter2=     %02x' % self._Parameter2)
        logdbg('HistoryInterval=%01x' % self._HistoryInterval)
        logdbg('Data=           %s' % self._Data) 
        logdbg('Lastbyte=       %02x' % self._Lastbyte)  
        logdbg('SensorIn=       %3.1f-%3.1f, %3.0f-%3.0f%' % (self._TempInMinMax._Min._Value, \
             self._TempInMinMax._Max._Value,self._HumidityInMinMax._Min._Value, \
             self._HumidityInMinMax._Max._Value))
        logdbg('Sensor1=        %3.1f-%3.1f, %3.0f-%3.0f, %s' % (self._Temp1MinMax._Min._Value, \
            self._Temp1MinMax._Max._Value,self._Humidity1MinMax._Min._Value, \
            self._Humidity1MinMax._Max._Value,self._Description1))
        logdbg('Sensor2=        %3.1f-%3.1f, %3.0f-%3.0f, %s'% (self._Temp2MinMax._Min._Value, \
            self._Temp2MinMax._Max._Value,self._Humidity2MinMax._Min._Value, \
            self._Humidity2MinMax._Max._Value,self._Description2))
        logdbg('Sensor3=        %3.1f-%3.1f, %3.0f-%3.0f, %s'% (self._Temp3MinMax._Min._Value, \
            self._Temp3MinMax._Max._Value,self._Humidity3MinMax._Min._Value, \
            self._Humidity3MinMax._Max._Value,self._Description3))
        logdbg('Sensor4=        %3.1f-%3.1f, %3.0f-%3.0f, %s'% (self._Temp4MinMax._Min._Value,\
            self._Temp4MinMax._Max._Value,self._Humidity4MinMax._Min._Value, \
            self._Humidity4MinMax._Max._Value,self._Description4))
        logdbg('Sensor5=        %3.1f-%3.1f, %3.0f-%3.0f, %s'% (self._Temp5MinMax._Min._Value, \
            self._Temp5MinMax._Max._Value,self._Humidity5MinMax._Min._Value, \
            self._Humidity5MinMax._Max._Value,self._Description5))
        logdbg('Sensor6=        %3.1f-%3.1f, %3.0f-%3.0f, %s'% (self._Temp6MinMax._Min._Value, \
            self._Temp6MinMax._Max._Value,self._Humidity6MinMax._Min._Value, \
            self._Humidity6MinMax._Max._Value,self._Description6)) 
        logdbg('Sensor7=        %3.1f-%3.1f, %3.0f-%3.0f, %s'% (self._Temp7MinMax._Min._Value, \
            self._Temp7MinMax._Max._Value,self._Humidity7MinMax._Min._Value, \
            self._Humidity7MinMax._Max._Value,self._Description7))
        logdbg('Sensor8=        %3.1f-%3.1f, %3.0f-%3.0f, %s'% (self._Temp8MinMax._Min._Value, \
            self._Temp8MinMax._Max._Value,self._Humidity8MinMax._Min._Value, \
            self._Humidity8MinMax._Max._Value,self._Description8))
...
class CHistoryData(object):
    ...
    def toLog(self):
        ...
        logdbg("Pos1Temp 1-8     = %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f" % (self.Pos1Temp1, self.Pos1Temp2, self.Pos1Temp3, self.Pos1Temp4, self.Pos1Temp5, self.Pos1Temp6, self.Pos1Temp7, self.Pos1Temp8))
        logdbg("Pos1Humidity 1-8 = %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f" % (self.Pos1Humidity1, self.Pos1Humidity2, self.Pos1Humidity3, self.Pos1Humidity4, self.Pos1Humidity5, self.Pos1Humidity6, self.Pos1Humidity7, self.Pos1Humidity8))
        if self.Pos2DateTime != self.Pos1DateTime:
            ...
            logdbg("Pos2Temp 1-8     = %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f" % (self.Pos2Temp1, self.Pos2Temp2, self.Pos2Temp3, self.Pos2Temp4, self.Pos2Temp5, self.Pos2Temp6, self.Pos2Temp7, self.Pos2Temp8))
            logdbg("Pos2Humidity 1-8 = %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f" % (self.Pos2Humidity1, self.Pos2Humidity2, self.Pos2Humidity3, self.Pos2Humidity4, self.Pos2Humidity5, self.Pos2Humidity6, self.Pos2Humidity7, self.Pos2Humidity8))
        if self.Pos3DateTime != self.Pos2DateTime:
            ...
            logdbg("Pos3Temp 1-8     = %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f" % (self.Pos3Temp1, self.Pos3Temp2, self.Pos3Temp3, self.Pos3Temp4, self.Pos3Temp5, self.Pos3Temp6, self.Pos3Temp7, self.Pos3Temp8))
            logdbg("Pos3Humidity 1-8 = %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f" % (self.Pos3Humidity1, self.Pos3Humidity2, self.Pos3Humidity3, self.Pos3Humidity4, self.Pos3Humidity5, self.Pos3Humidity6, self.Pos3Humidity7, self.Pos3Humidity8))
        if self.Pos4DateTime != self.Pos3DateTime:
            ...
            logdbg("Pos4Temp 1-8     = %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f" % (self.Pos4Temp1, self.Pos4Temp2, self.Pos4Temp3, self.Pos4Temp4, self.Pos4Temp5, self.Pos4Temp6, self.Pos4Temp7, self.Pos4Temp8))
            logdbg("Pos4Humidity 1-8 = %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f" % (self.Pos4Humidity1, self.Pos4Humidity2, self.Pos4Humidity3, self.Pos4Humidity4, self.Pos4Humidity5, self.Pos4Humidity6, self.Pos4Humidity7, self.Pos4Humidity8))
        if self.Pos5DateTime != self.Pos4DateTime:
            ...
            logdbg("Pos5Temp 1-8     = %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f" % (self.Pos5Temp1, self.Pos5Temp2, self.Pos5Temp3, self.Pos5Temp4, self.Pos5Temp5, self.Pos5Temp6, self.Pos5Temp7, self.Pos5Temp8))
            logdbg("Pos5Humidity 1-8 = %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f" % (self.Pos5Humidity1, self.Pos5Humidity2, self.Pos5Humidity3, self.Pos5Humidity4, self.Pos5Humidity5, self.Pos5Humidity6, self.Pos5Humidity7, self.Pos5Humidity8))
        if self.Pos6DateTime != self.Pos5DateTime:
            ...
            logdbg("Pos6Temp 1-8     = %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f, %3.1f" % (self.Pos6Temp1, self.Pos6Temp2, self.Pos6Temp3, self.Pos6Temp4, self.Pos6Temp5, self.Pos6Temp6, self.Pos6Temp7, self.Pos6Temp8))
            logdbg("Pos6Humidity 1-8 = %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f, %3.0f" % (self.Pos6Humidity1, self.Pos6Humidity2, self.Pos6Humidity3, self.Pos6Humidity4, self.Pos6Humidity5, self.Pos6Humidity6, self.Pos6Humidity7, self.Pos6Humidity8))


    def asDict1(self):
        """emit historical data Pos1 as a dict with weewx conventions"""
        return {
            'dateTime': tstr_to_ts(str(self.Pos1DateTime)),
            self.sensor_map['TempIn']: get_datum_diff(self.Pos1TempIn,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['HumidityIn']: get_datum_diff(data.HumidityIn,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp1']: get_datum_diff(self.Pos1Temp1,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidit1']: get_datum_diff(self.Pos1Humidity1,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp2']: get_datum_diff(self.Pos1Temp2,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity2']: get_datum_diff(self.Pos1Humidity2,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp3']: get_datum_diff(self.Pos1Temp3,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity3']: get_datum_diff(self.Pos1Humidity3,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp4']: get_datum_diff(self.Pos1Temp4,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity4']: get_datum_diff(self.Pos1Humidity4,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp5']: get_datum_diff(self.Pos1Temp5,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity5']: get_datum_diff(self.Pos1Humidity5,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp6']: get_datum_diff(self.Pos1Temp6,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity6']: get_datum_diff(self.Pos1Humidity6,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp7']: get_datum_diff(self.Pos1Temp7,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity7']: get_datum_diff(self.Pos1Humidity7,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp8']: get_datum_diff(self.Pos1Temp8,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity8']: get_datum_diff(self.Pos1Humidity8,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            }

    def asDict2(self):
        """emit historical data Pos2 as a dict with weewx conventions"""
        return {
            'dateTime': tstr_to_ts(str(self.Pos2DateTime)),
            self.sensor_map['TempIn']: get_datum_diff(self.Pos2TempIn,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['HumidityIn']: get_datum_diff(self.Pos2HumidityIn,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp1']: get_datum_diff(self.Pos2Temp1,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidit1']: get_datum_diff(self.Pos2Humidity1,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp2']: get_datum_diff(self.Pos2Temp2,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity2']: get_datum_diff(self.Pos2Humidity2,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp3']: get_datum_diff(self.Pos2Temp3,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity3']: get_datum_diff(self.Pos2Humidity3,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp4']: get_datum_diff(self.Pos2Temp4,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity4']: get_datum_diff(self.Pos2Humidity4,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp5']: get_datum_diff(self.Pos2Temp5,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity5']: get_datum_diff(self.Pos2Humidity5,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp6']: get_datum_diff(self.Pos2Temp6,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity6']: get_datum_diff(self.Pos2Humidity6,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp7']: get_datum_diff(self.Pos2Temp7,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity7']: get_datum_diff(self.Pos2Humidity7,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp8']: get_datum_diff(self.Pos2Temp8,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity8']: get_datum_diff(self.Pos2Humidity8,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            }

    def asDict3(self):
        """emit historical data Pos3 as a dict with weewx conventions"""
        return {
            'dateTime': tstr_to_ts(str(self.Pos3DateTime)),
            self.sensor_map['TempIn']: get_datum_diff(self.Pos3TempIn,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['HumidityIn']: get_datum_diff(self.Pos3HumidityIn,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp1']: get_datum_diff(self.Pos3Temp1,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidit1']: get_datum_diff(self.Pos3Humidity1,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp2']: get_datum_diff(self.Pos3Temp2,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity2']: get_datum_diff(self.Pos3Humidity2,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp3']: get_datum_diff(self.Pos3Temp3,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity3']: get_datum_diff(self.Pos3Humidity3,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp4']: get_datum_diff(self.Pos3Temp4,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity4']: get_datum_diff(self.Pos3Humidity4,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp5']: get_datum_diff(self.Pos3Temp5,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity5']: get_datum_diff(self.Pos3Humidity5,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp6']: get_datum_diff(self.Pos3Temp6,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity6']: get_datum_diff(self.Pos3Humidity6,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp7']: get_datum_diff(self.Pos3Temp7,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity7']: get_datum_diff(self.Pos3Humidity7,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp8']: get_datum_diff(self.Pos3Temp8,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity8']: get_datum_diff(self.Pos3Humidity8,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            }

    def asDict4(self):
        """emit historical data Pos4 as a dict with weewx conventions"""
        return {
            'dateTime': tstr_to_ts(str(self.Pos4DateTime)),
            self.sensor_map['TempIn']: get_datum_diff(self.Pos4TempIn,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['HumidityIn']: get_datum_diff(self.Pos4HumidityIn,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp1']: get_datum_diff(self.Pos4Temp1,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidit1']: get_datum_diff(self.Pos4Humidity1,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp2']: get_datum_diff(self.Pos4Temp2,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity2']: get_datum_diff(self.Pos4Humidity2,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp3']: get_datum_diff(self.Pos4Temp3,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity3']: get_datum_diff(self.Pos4Humidity3,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp4']: get_datum_diff(self.Pos4Temp4,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity4']: get_datum_diff(self.Pos4Humidity4,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp5']: get_datum_diff(self.Pos4Temp5,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity5']: get_datum_diff(self.Pos4Humidity5,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp6']: get_datum_diff(self.Pos4Temp6,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity6']: get_datum_diff(self.Pos4Humidity6,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp7']: get_datum_diff(self.Pos4Temp7,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity7']: get_datum_diff(self.Pos4Humidity7,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp8']: get_datum_diff(self.Pos4Temp8,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity8']: get_datum_diff(self.Pos4Humidity8,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            }

    def asDict5(self):
        """emit historical data Pos5 as a dict with weewx conventions"""
        return {
            'dateTime': tstr_to_ts(str(self.Pos5DateTime)),
            self.sensor_map['TempIn']: get_datum_diff(self.Pos5TempIn,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['HumidityIn']: get_datum_diff(self.Pos5HumidityIn,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp1']: get_datum_diff(self.Pos5Temp1,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidit1']: get_datum_diff(self.Pos5Humidity1,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp2']: get_datum_diff(self.Pos5Temp2,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity2']: get_datum_diff(self.Pos5Humidity2,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp3']: get_datum_diff(self.Pos5Temp3,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity3']: get_datum_diff(self.Pos5Humidity3,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp4']: get_datum_diff(self.Pos5Temp4,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity4']: get_datum_diff(self.Pos5Humidity4,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp5']: get_datum_diff(self.Pos5Temp5,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity5']: get_datum_diff(self.Pos5Humidity5,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp6']: get_datum_diff(self.Pos5Temp6,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity6']: get_datum_diff(self.Pos5Humidity6,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp7']: get_datum_diff(self.Pos5Temp7,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity7']: get_datum_diff(self.Pos5Humidity7,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp8']: get_datum_diff(self.Pos5Temp8,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity8']: get_datum_diff(self.Pos5Humidity8,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            }

    def asDict6(self):
        """emit historical data Pos6 as a dict with weewx conventions"""
        return {
            'dateTime': tstr_to_ts(str(self.Pos6DateTime)),
            self.sensor_map['TempIn']: get_datum_diff(self.Pos6TempIn,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['HumidityIn']: get_datum_diff(self.Pos6HumidityIn,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp1']: get_datum_diff(self.Pos6Temp1,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidit1']: get_datum_diff(self.Pos6Humidity1,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp2']: get_datum_diff(self.Pos6Temp2,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity2']: get_datum_diff(self.Pos6Humidity2,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp3']: get_datum_diff(self.Pos6Temp3,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity3']: get_datum_diff(self.Pos6Humidity3,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp4']: get_datum_diff(self.Pos6Temp4,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity4']: get_datum_diff(self.Pos6Humidity4,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp5']: get_datum_diff(self.Pos6Temp5,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity5']: get_datum_diff(self.Pos6Humidity5,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp6']: get_datum_diff(self.Pos6Temp6,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity6']: get_datum_diff(self.Pos6Humidity6,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp7']: get_datum_diff(self.Pos6Temp7,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity7']: get_datum_diff(self.Pos6Humidity7,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            self.sensor_map['Temp8']: get_datum_diff(self.Pos6Temp8,CWeatherTraits.TemperatureNP(),CWeatherTraits.TemperatureOFL()),
            self.sensor_map['Humidity8']: get_datum_diff(self.Pos6Humidity8,CWeatherTraits.HumidityNP(),CWeatherTraits.HumidityOFL()),
            }
...
class sHID(object):
    ...
    def dump(self, cmd, buf, fmt='auto', len=301):
        strbuf = ''
        msglen = None
        if fmt == 'auto':
            ...
            msglen = len                   # dedicated 'long' length
...
class CCommunicationService(object):
    ...
    def buildConfigFrame(self, buf):
        ...
        self.shid.dump('Out_lh', cfgbuf[0], fmt='long', len=125)
        if changed:
            self.shid.dump('OutBuf', cfgbuf[0], fmt='long', len=125)
            newbuf[0][0] = buf[0][0]
            newbuf[0][1] = buf[0][1]
            newbuf[0][2] = EAction.aGetCurrent ###lh EAction.aSendConfig # 0x20 # change this value if we won't store config
            newbuf[0][3] = buf[0][3]
            for i in xrange(0,211):
    ...
    def handleConfig(self, buf, length):
        ...
        if DEBUG_CONFIG_DATA < 99: ###lh #> 2:
            self.shid.dump('InBuf', buf[0], fmt='long', len=125)
        newbuf=[0]
        newbuf[0] = buf[0]
        newlength = [0]
        now = int(time.time())
        self.DataStore.StationConfig.read(newbuf)
        if DEBUG_CONFIG_DATA < 99: ###lh #> 1:
        ...
        newlength[0] = self.buildACKFrame(newbuf, EAction.aGetHistory, cs)
    ...
    def handleCurrentData(self, buf, length):
        ...
        # get sumcheck of config buffer in KlimaLogg
        cs = newbuf[0][6] | (newbuf[0][5] << 8)
        cfgbuf = [0]
        cfgbuf[0] = [0]*125
        # build contents of cfgbuf in testConfigChanged with current config variables 
        changed = self.DataStore.StationConfig.testConfigChanged(cfgbuf)
        ...
        if inBufCS == 0: ###lh for test only if empty #or inBufCS != cs:
            ...
            self.setSleep(0.300,0.010)
            newlength[0] = self.buildACKFrame(newbuf, EAction.aGetConfig, cs)
        elif changed:
            # Request for a set config
            logdbg('handleCurrentData: outBufCS of station changed')
            self.setSleep(0.300,0.010)
            newlength[0] = self.buildACKFrame(newbuf, EAction.aReqSetConfig, cs)
        else:
    ...
    def handleHistoryData(self, buf, buflen):
        ...
        ts_1900 = datetime(1900, 01, 01, 00, 00)
        ts_first_rec = tstr_to_ts(str(data.Pos1DateTime))
        if ts_first_rec == ts_1900:
            # the first history record has date-time 1900-01-01 00:00:00
            # fetch the time of the second message
            ts_first_rec = tstr_to_ts(str(data.Pos2DateTime))
        ...
        if self.command == EAction.aGetHistory:
            if self.history_cache.start_index is None:
                ...
                ###lh thisIndex should be the 1-6 record(s) after next_index
                indexRequested = self.history_cache.next_index
                ###lh TODO: check for indexRequested+(1-6) > KlimaLoggDriver.max_records
                if thisIndex >= indexRequested+1 and thisIndex <= indexRequested+6:
                    # get the next 1-6 history record(s)
                    if ts_first_rec is not None and self.history_cache.since_ts <= ts_first_rec:
                        # check if first record has date-time 1900:01-01 00:00:00
                        if tstr_to_ts(str(data.Pos1DateTime)) == ts_1900:
                            logdbg('handleHistoryData: skip non valid history record on Pos1'
                                   ' %s: %s' % (thisIndex, data.asDict1()))
                        else:
                            # Check if two records in a row with the same ts
                            if self.history_cache.last_ts == ts_first_rec:
                                logdbg('handleHistoryData: remove previous record'
                                       ' with duplicate timestamp: %s' %
                                       weeutil.weeutil.timestamp_to_string(ts_first_rec))
                                self.history_cache.records.pop()
                            self.history_cache.last_ts = ts_first_rec
                            # append record 1 to the history
                            logdbg('handleHistoryData: appending history record on Pos1'
                                   ' %s: %s' % (thisIndex, data.asDict1()))
                            self.history_cache.records.append(data.asDict1())
                            self.history_cache.num_scanned += 1
                        # append records 2-6 to the history
                        if data.Pos2DateTime != data.Pos1DateTime:
                            logdbg('handleHistoryData: appending history record on Pos2'
                                   ' %s: %s' % (thisIndex, data.asDict2()))
                            self.history_cache.records.append(data.asDict2())
                            self.history_cache.num_scanned += 1
                        if data.Pos3DateTime != data.Pos2DateTime:
                            logdbg('handleHistoryData: appending history record on Pos3'
                                   ' %s: %s' % (thisIndex, data.asDict3()))
                            self.history_cache.records.append(data.asDict3())
                            self.history_cache.num_scanned += 1
                        if data.Pos4DateTime != data.Pos3DateTime:
                            logdbg('handleHistoryData: appending history record on Pos4'
                                   ' %s: %s' % (thisIndex, data.asDict4()))
                            self.history_cache.records.append(data.asDict4())
                            self.history_cache.num_scanned += 1
                        if data.Pos5DateTime != data.Pos4DateTime:
                            logdbg('handleHistoryData: appending history record on Pos5'
                                   ' %s: %s' % (thisIndex, data.asDict5()))
                            self.history_cache.records.append(data.asDict5())
                            self.history_cache.num_scanned += 1
                        if data.Pos6DateTime != data.Pos5DateTime:
                            logdbg('handleHistoryData: appending history record on Pos6'
                                   ' %s: %s' % (thisIndex, data.asDict6()))
                            self.history_cache.records.append(data.asDict6())
                            self.history_cache.num_scanned += 1
                        self.history_cache.num_outstanding_records = nrec
                    elif ts_first_rec is None:
                        logerr('handleHistoryData: skip record: ts_first_rec=None')
                    else:
                        logdbg('handleHistoryData: skip record: since_ts=%s ts_first_rec=%s' % (weeutil.weeutil.timestamp_to_string(self.history_cache.since_ts), weeutil.weeutil.timestamp_to_string(ts_first_rec)))
    ...
    def generateResponse(self, buf, length):
        ...
        if bufferID == 0xF0F0:
            ...
            newlength[0] = self.buildACKFrame(newbuf, EAction.aGetConfig, deviceID, 0xFFFF)
    ...
    def doRF(self):
        try:
            ...
            if weewx.debug:
                ###lh log_traceback(dst=syslog.LOG_DEBUG)
    ...
    def doRFCommunication(self):
        ...
        Framebuf=[0]
        Framebuf[0]=[0]*0x03
        self.shid.getFrame(Framebuf, Datalength)
        try:
            self.generateResponse(Framebuf, Datalength)
            self.shid.setFrame(Framebuf[0], Datalength[0])
